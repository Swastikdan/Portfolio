const ProjectData = [
  {
    ...
    "ProjectDescription": "E-Commerce Web app built using Django",
  ...
  {
    "ProjectName": "Hotel Booking Application",
    "ProjectDescription": "Find, compare, and reserve your ideal hotel.",
  ...
  {
    "ProjectName": "Recipe Seeker Webapp",
    "ProjectDescription": "A web app where users can search for recipes.",
    ...
    "ProjectName": "Film Fanatic Website",
    "ProjectDescription": "A movie data display website with TMDB api.",
  ...
  },
  {
    ...
    "ProjectDescription": "Generate strong & secure passwords online.",
  ...
  {
    "ProjectName": "Netflix Clone (Front End)",
    "ProjectDescription": "A clone of the Netflix website. ",
    "TechStack": ["JavaScript","Vite Js","Tailwind","HTML5"],
