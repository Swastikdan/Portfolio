...
export default function Home() {
  return (
    <>
      <div
        aria-hidden="true"
        className="fixed bg-fixed inset-0 grid grid-cols-2 -space-x-52 opacity-20 dark:opacity-20 blur-xl"
      >
        <div className="blur-[106px] h-96 bg-gradient-to-br from-orange-300/10 to-purple-400 "></div>
